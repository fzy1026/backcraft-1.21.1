...
@Mod(value = Backcraft.MODID, dist = Dist.CLIENT)
// You can use EventBusSubscriber to automatically register all static methods in the class annotated with @SubscribeEvent
@EventBusSubscriber(modid = Backcraft.MODID, value = Dist.CLIENT)
public class BackcraftClient {
    public BackcraftClient(ModContainer container) {
