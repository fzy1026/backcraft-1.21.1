package com.cham.backcraft.entity;// Made with Blockbench 5.0.2
...
public class SmilerModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(0, 32).addBox(-1.0F, -32.0F, -8.0F, 2.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
